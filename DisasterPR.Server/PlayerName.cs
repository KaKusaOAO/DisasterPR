...
public static class PlayerName
{
    ...
    private static void InitVocabularies()
    {
        ...
        {
            "自信的", "可愛的", "衝動的", "熱情的", "熱心的", "狂暴的", "狂熱的", "狂野的", "狡猾的", "狡詐的",
            "搞笑的", "搖滾的", "搖擺的", "狂喜的", "歡樂的", "快樂的", "猥瑣的", "色色的", "沉思的", "沉默的",
            "沉重的", "沉悶的", "沉穩的", "幼稚的", "膽小的", "勇敢的", "大膽的", "改變世界的", "改變命運的", "改變人生的",
            "領頭的", "香香的", "臭臭的", "瘦瘦的", "胖胖的", "受受的", "極致的", "憤怒的", "極速的", "緩慢的",
            "遲鈍的", "煉銅的", "爆肝的", "變態的", "笨拙的", "聰明的", "理智的"
        }.ToHashSet());
